  ...
  if (children.length > 1) {
    ...
    for (const c of children) {
      if (c.type !== Comment) {
        ...
        child = c;
        hasFound = true;
        if (!!!('production' !== "production")) break;
      }
    }
  }
  return child;
...
function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
  ...
  const canSetRef = (ref2, key) => {
    if (!!('production' !== "production") && knownTemplateRefs.has(ref2)) {
      return false;
    }
...
function applyOptions(instance) {
  ...
  if (computedOptions) {
    for (const key in computedOptions) {
      ...
      const set = !isFunction(opt) && isFunction(opt.set) ? opt.set.bind(publicThis) : !!('production' !== "production") ? () => {
        warn$1(
...
function renderComponentRoot(instance) {
  ...
  if (vnode.transition) {
    ...
    if (!!('production' !== "production") && !isElementRoot(child)) {
      warn$1(
...
function baseCreateRenderer(options, createHydrationFns) {
  ...
  const patch = (n1, n2, container, anchor = null, parentComponent = null, parentSuspense = null, namespace = void 0, slotScopeIds = null, optimized = !!('production' !== "production") && isHmrUpdating ? false : !!n2.dynamicChildren) => {
    if (n1 === n2) {
      return;
    }
  ...
  const mountElement = (vnode, container, anchor, parentComponent, parentSuspense, namespace, slotScopeIds, optimized) => {
    ...
    if ((vnodeHook = props && props.onVnodeMounted) || needCallTransitionHooks || dirs) {
      const isHmr = !!('production' !== "production") && isHmrUpdating;
      queuePostRenderEffect(() => {
        let prev;
        if (!!('production' !== "production")) prev = setHmrUpdating(isHmr);
        try {
          vnodeHook && invokeVNodeHook(vnodeHook, parentComponent, vnode);
          needCallTransitionHooks && transition.enter(el);
          dirs && invokeDirectiveHook(vnode, null, parentComponent, "mounted");
        } finally {
          if (!!('production' !== "production")) setHmrUpdating(prev);
        }
      }, parentSuspense);
    }
  };
  ...
  const patchElement = (n1, n2, parentComponent, parentSuspense, namespace, slotScopeIds, optimized) => {
    ...
    if (
      ...
      !!('production' !== "production") && isHmrUpdating || // #6385 the old vnode may be a user-wrapped non-isomorphic block
...
function createBaseVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, shapeFlag = type === Fragment ? 0 : 1, isBlockNode = false, needFullChildrenNormalization = false) {
  ...
  if (!!('production' !== "production") && props && vnode.shapeFlag & 1) {
...
function cloneVNode(vnode, extraProps, mergeRef = false, cloneTransition = false) {
  ...
  const cloned = {
    ...
    children: !!('production' !== "production") && patchFlag === -1 && isArray(children) ? children.map(deepCloneVNode) : children,
    target: vnode.target,
...
export { computed as A, onUnmounted as B, shallowRef as C, nextTick as D, Fragment as F, Icon as I, NOOP as N, isHTMLTag as a, isSVGTag as b, createRenderer as c, isMathMLTag as d, isString as e, extend as f, isOn as g, isModelListener as h, isFunction as i, camelize as j, includeBooleanAttr as k, isSymbol as l, isSpecialBooleanAttr as m, isArray as n, hyphenate as o, capitalize as p, callWithAsyncErrorHandling as q, ref as r, watchEffect as s, purify as t, defineComponent as u, h as v, warn as w, clsx as x, onMounted as y, watch as z };
//# sourceMappingURL=shared-hxLjVLGs.js.map
